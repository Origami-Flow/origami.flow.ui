const SearchInput = () => {
    return (
        <form class="max-w-md w-[50vw] self-end mb-4 max-md:w-full">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-rosesecundary focus:border-rosesecundary" placeholder="" required />
