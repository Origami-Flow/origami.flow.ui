...
const Menu = () => {
    return(
        <div id="menu" className="hidden z-10 relative lg:hidden flex-col pt-28 justify-evenly text-xl text-branconeutro bg-roseprimary/95 w-full h-96 p-6 items-center">
